...
frame.src='../avatar/index.html?review=1&parentOrigin='+encodeURIComponent(origin)+'&v=natural1';
...
if(d.type==='prime-ready'){ready=true;play.disabled=!bytes;status.textContent=bytes?'Ready for review — half-speed playback':'Select the saved timestamp-validation WAV to begin.';}
