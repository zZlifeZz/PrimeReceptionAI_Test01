...
For the current native Human Generator working direction, use [NATIVE-RECEPTIONIST.md](NATIVE-RECEPTIONIST.md). This document also records the earlier Aurelia fallback.
